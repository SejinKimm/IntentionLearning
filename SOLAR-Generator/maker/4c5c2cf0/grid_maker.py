    ...
    def parse(self, **kwargs) -> List[Tuple[List[NDArray], List[NDArray], List[NDArray], List[NDArray], Dict]]:
        ...
        while num < num_samples:
            ...
            while (j < num_examples+1):
                ...
                rand_grid[p_x-1][p_y-1] = p_color       # 좌상
                rand_grid[p_x-1][p_y+1] = p_color       # 좌하
                rand_grid[p_x+1][p_y-1] = p_color       # 우상
                rand_grid[p_x+1][p_y+1] = p_color       # 우하

                answer_grid[p_x-1][p_y-1] = p_color       # 좌상
                answer_grid[p_x-1][p_y+1] = p_color       # 좌하
                answer_grid[p_x+1][p_y-1] = p_color       # 우상
                answer_grid[p_x+1][p_y+1] = p_color       # 우하
