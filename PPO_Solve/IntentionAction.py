...
class IntentionActionEnv(O2ARCv2Env):
    ...
    def create_operations(self) :
        ...
        for i, op in enumerate(ops):
             if i in [0, 1, 2, 10, 11, 12, 20, 21, 22, 23, 34]: #[24,25,26,27,34]: #[4,6,8,9,24,25,26,27, 29, 30, 21, 34]:
    ...
    def reset(self, seed = None, options: Optional[Dict] = None, subprob = None):
        ...
        self.submit_count = 0
        self.intention_action: ActType  = None
        self.intention_action_op : SupportsIndex  = None
        #self.intention_last_popular_state: Act  = None
        ...
        if self.adaptation:
            ...
            self.subprob_index = 0 #sjkim_250116
